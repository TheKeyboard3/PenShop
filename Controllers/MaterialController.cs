...
namespace PenShop.Controllers
{
    public class MaterialController : Controller
    {
        ...
        public MaterialController(PenShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Material != null ? 
                          ...
                          Problem("Entity set 'PenShopContext.Material'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PenShopContext.Material'  is null.");
            }
            var material = await _context.Material.FindAsync(id);
            if (material != null)
            {
